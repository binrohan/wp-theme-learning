    ...
    <div class="container">
      ...
      <div class="site-header__menu group">
        ...
        <div class="site-header__util">
          ...
          ?>
            <a href="<?php echo wp_logout_url() ?>" class="btn btn--small  btn--dark-orange float-left btn btn--with-photo">
            <span class="site-header__avatar"><?php echo get_avatar(get_current_user_id(), 60); ?></span><span class="btn__text">Log out</span>
            </a>
          <?php
